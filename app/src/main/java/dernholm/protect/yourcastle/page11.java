...
public class page11 extends AppCompatActivity implements OnUserEarnedRewardListener {
    @Override
    ...
    private long backPressedTime11;                                                          // wprowadzenie zmiennej "backPressedTime2"
    private RewardedInterstitialAd rewardedInterstitialAd;                                  // wprowadzenie zmiennej "rewardedInterstitialAd"
    final String TAG = "page11";                                                             // wprowadzenie zmiennej "TAG"
    ...
    public void onBackPressed() {                                                           // kliknięcie przez użytkownika dwukrotnie przycisku powrót
        if(backPressedTime11+2000>System.currentTimeMillis()){                                // spowoduje przejście do ekranu głównego urządzenie
        ...
        backPressedTime11 = System.currentTimeMillis();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page11);                                                     // wywołanie interfejsu użytkownika "page2"
        ImageView scout_animation = findViewById(R.id.scout11);                              //
        ...
        final Button button_animation = findViewById(R.id.button_scout11);                   // wprowadzenie przycisku "button_animation" odnoszącego się do przycisku z interfejsu użytkownnika o id "button_scout2".
        final Button correct2_button1 = findViewById(R.id.next11_1);                         // wprowadzenie czterech przycisków odnoszących się
        final Button incorrect2_button2 = findViewById(R.id.next11_2);                       // do przycisków z interfejsu użytkownika o id next2_1 itd.
        final Button incorrect2_button3 = findViewById(R.id.next11_3);                       // przyciski te są nałożone na siebie
        final Button incorrect2_button4 = findViewById(R.id.next11_4);                       // kliknięcie poprawnego przycisku nagradza użyt
        final RadioButton opcja1 = findViewById(R.id.radioButton11_1);                         //
        final RadioButton opcja2 = findViewById(R.id.radioButton11_2);                         //
        final RadioButton opcja3 = findViewById(R.id.radioButton11_3);                         // wprowadzenie przycisków wyboru jednej z czterech opcji
        final RadioButton opcja4 = findViewById(R.id.radioButton11_4);                         // odnoszących się do radiobuttons z layoutu użytkownika o id radioButton1 itd.
        final RadioButton opcja5 = findViewById(R.id.radioButton11_5);                         // wprowadzenie fejk przycisku, eliminującego błedy.
        final ImageButton scroll = findViewById(R.id.scrollid11);                             // wprowadzenie graficznego przycisku "scroll" odnoszącego się do przycisku z layoutu użytkownika o id "scrollid"
     ...
     /*   mInterstitialAd = new InterstitialAd(this);
        ...
        mAdView = findViewById(R.id.banner11);                                               // powiązanie zmiennej mAdView z banerem z interfejsu użytkownika o id banner2
        AdRequest adRequest = new AdRequest.Builder().build();                              //
        mAdView.loadAd(adRequest);                                                          //
        final TextView ilosczlota2 = findViewById(R.id.amout_gold11);                        // wprowadzenie tekstu "ilosczlota2" powiązanego z id "amout_gold2" z layoutu
        final Button pożyczka2 = findViewById(R.id.credit11);                                // wprowadzenie przycisku "pożyczka2" powiązanego z przyciskiem o id "credit2" z layoutu
            ...
            public void onClick(View v) {                                                   //
                if(ilosczlotaa>=50) {                                                       // możliwe tylko dla ilosczlotaa=>50 (posiadanej ilości waluty przez użytkownika)
                    ...
                    handler.postDelayed(() -> {                                             // z opóźnieniem równym 2 sekundy ujawnienie przycisku "scroll", który przekazuje użytkownikowi wskazówki fabularne
                        ...
                        findViewById(R.id.scout11).setVisibility(View.GONE);                 //
                    }, 2000);                                                      //
        ...
        scroll.setOnClickListener(view ->{                                                  // klikniecie przycisku "scroll" powoduje ujawnienie po 0,2s layoutu o id "infoscroll2"
            ...
            final Handler handler = new Handler();
            handler.postDelayed(() -> {
                findViewById(R.id.infoscroll11).setVisibility(View.VISIBLE);
        ...
        final Button scrollback2 = findViewById(R.id.backscroll11);                               // wprowadzenie przycisku "scrollback2" odnoszący się to przycisku z layoutu o id "backscroll2.
        scrollback2.setOnClickListener(v -> {                                                    // klikniecie przycisku "scrollback2"
            ...
            final Handler handler = new Handler();
            handler.postDelayed(() -> {
                findViewById(R.id.infoscroll11).setVisibility(View.INVISIBLE);                   // powoduje znikniecie po 0,2s layoutu o id "infoscroll2"
                // w interfejsie użytkownika jest to powrót do głównej zawartości aktywności.
            }, 200);
        ...
        pożyczka2.setOnClickListener(v -> {
            ...
            if (rewardedInterstitialAd != null) {
                rewardedInterstitialAd.show(/* Activity */ page11.this,/*
OnUserEarnedRewardListener */ page11.this);
                mp.pause();
            } else {
                Toast.makeText(page11.this, "Ad Not Loaded", Toast.LENGTH_SHORT).show();
        ...
        opcja1.setOnClickListener(view -> {
            ...
            if (ilosczlotaa<30){    // zmienić wartość dla nowych odpowiedzi
        ...
        correct2_button1.setOnClickListener(v -> {
            findViewById(R.id.wygrales11).setVisibility(View.VISIBLE);
            mp.setVolume((float)0.12,(float)0.12);
        });

        final Button wygrales_button = findViewById(R.id.next11);
        wygrales_button.setOnClickListener(v -> {
            numer++;
            ilosczlotaa = ilosczlotaa + 40; // zmiana wartości dla dobrej odpowiedzi
        ...
        incorrect2_button2.setOnClickListener(v -> {
            ...
            editor.putInt("ilosczlotaaa", ilosczlotaa);
            editor.apply();
            findViewById(R.id.przegrales11).setVisibility(View.VISIBLE);
            findViewById(R.id.radioButton11_2).setVisibility(View.INVISIBLE);
            incorrect2_button2.setEnabled(false);
            incorrect2_button2.setVisibility(View.INVISIBLE);
        });
        ...
        incorrect2_button3.setOnClickListener(v -> {
            ...
            ilosczlotaa = ilosczlotaa - 30;  // zmiana wartości dla złej odpowiedzi
            SharedPreferences saveLayout = getSharedPreferences(SAVE, MODE_PRIVATE);
            SharedPreferences.Editor editor = saveLayout.edit();
            ilosczlota2.setText(String.valueOf(ilosczlotaa));
            editor.putInt("ilosczlotaaa", ilosczlotaa);
            editor.apply();
            findViewById(R.id.przegrales11).setVisibility(View.VISIBLE);
            findViewById(R.id.radioButton11_1).setVisibility(View.INVISIBLE);
            incorrect2_button3.setEnabled(false);
            incorrect2_button3.setVisibility(View.INVISIBLE);
        });
        ...
        incorrect2_button4.setOnClickListener(v -> {
            ...
            editor.apply();
            findViewById(R.id.przegrales11).setVisibility(View.VISIBLE);
            findViewById(R.id.radioButton11_4).setVisibility(View.INVISIBLE);
            incorrect2_button4.setEnabled(false);
            incorrect2_button4.setVisibility(View.INVISIBLE);
        });

        final Button you_lose = findViewById(R.id.powrot11);
        you_lose.setOnClickListener(v -> {
            findViewById(R.id.przegrales11).setVisibility(View.INVISIBLE);
...
// należy zamienić parametry opcji 1 z prawidłową opcją. Oraz dać znikanie radioButton7_1 jeżeli inna opcja niż 1 będzie prawidłowa.
    ...
    private void loadAd() {
        ...
        RewardedInterstitialAd.load(page11.this, "ca-app-pub-3940256099942544/5354046379",
    ...
    public void openpage11(){
        Intent intent11 = new Intent(this, page11.class);                         // wprowadzenie intencji "intent2" otwierającej aktywność "page3.class"
        startActivity(intent11);                                                             // metoda otwierająca aktywność opisaną w intencji "intent2"
    }
    public void openendgame(){
        Intent intent11 = new Intent(this, endgame.class);                         // wprowadzenie intencji "intent2" otwierającej aktywność "page3.class"
        startActivity(intent11);                                                             // metoda otwierająca aktywność opisaną w intencji "intent2"
    }
