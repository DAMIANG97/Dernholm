...
public class page4 extends AppCompatActivity implements OnUserEarnedRewardListener {
    @Override
    ...
    private long backPressedTime4;                                                          // wprowadzenie zmiennej "backPressedTime2"
    private RewardedInterstitialAd rewardedInterstitialAd;                                  // wprowadzenie zmiennej "rewardedInterstitialAd"
    final String TAG = "page4";                                                             // wprowadzenie zmiennej "TAG"
    ...
    public void onBackPressed() {                                                           // kliknięcie przez użytkownika dwukrotnie przycisku powrót
        if(backPressedTime4+2000>System.currentTimeMillis()){                                // spowoduje przejście do ekranu głównego urządzenie
        ...
        backPressedTime4 = System.currentTimeMillis();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page4);                                                     // wywołanie interfejsu użytkownika "page2"
        ImageView scout_animation = findViewById(R.id.scout4);                              //
        ...
        final Button button_animation = findViewById(R.id.button_scout4);                   // wprowadzenie przycisku "button_animation" odnoszącego się do przycisku z interfejsu użytkownnika o id "button_scout2".
        final Button correct2_button1 = findViewById(R.id.next4_1);                         // wprowadzenie czterech przycisków odnoszących się
        final Button incorrect2_button2 = findViewById(R.id.next4_2);                       // do przycisków z interfejsu użytkownika o id next2_1 itd.
        final Button incorrect2_button3 = findViewById(R.id.next4_3);                       // przyciski te są nałożone na siebie
        final Button incorrect2_button4 = findViewById(R.id.next4_4);                       // kliknięcie poprawnego przycisku nagradza użyt
        final RadioButton opcja1 = findViewById(R.id.radioButton4_1);                         //
        final RadioButton opcja2 = findViewById(R.id.radioButton4_2);                         //
        final RadioButton opcja3 = findViewById(R.id.radioButton4_3);                         // wprowadzenie przycisków wyboru jednej z czterech opcji
        final RadioButton opcja4 = findViewById(R.id.radioButton4_4);                         // odnoszących się do radiobuttons z layoutu użytkownika o id radioButton1 itd.
        final RadioButton opcja5 = findViewById(R.id.radioButton4_5);                         // wprowadzenie fejk przycisku, eliminującego błedy.
        final ImageButton scroll = findViewById(R.id.scrollid4);                             // wprowadzenie graficznego przycisku "scroll" odnoszącego się do przycisku z layoutu użytkownika o id "scrollid"
     ...
     /*   mInterstitialAd = new InterstitialAd(this);
        ...
        mAdView = findViewById(R.id.banner4);                                               // powiązanie zmiennej mAdView z banerem z interfejsu użytkownika o id banner2
        AdRequest adRequest = new AdRequest.Builder().build();                              //
        mAdView.loadAd(adRequest);                                                          //
        final TextView ilosczlota2 = findViewById(R.id.amout_gold4);                        // wprowadzenie tekstu "ilosczlota2" powiązanego z id "amout_gold2" z layoutu
        final Button pożyczka2 = findViewById(R.id.credit4);                                // wprowadzenie przycisku "pożyczka2" powiązanego z przyciskiem o id "credit2" z layoutu
            ...
            public void onClick(View v) {                                                   //
                if(ilosczlotaa>=50) {                                                       // możliwe tylko dla ilosczlotaa=>50 (posiadanej ilości waluty przez użytkownika)
                    ...
                    handler.postDelayed(() -> {                                             // z opóźnieniem równym 2 sekundy ujawnienie przycisku "scroll", który przekazuje użytkownikowi wskazówki fabularne
                        ...
                        findViewById(R.id.scout4).setVisibility(View.GONE);                 //
                    }, 2000);                                                      //
        ...
        scroll.setOnClickListener(view ->{                                                  // klikniecie przycisku "scroll" powoduje ujawnienie po 0,2s layoutu o id "infoscroll2"
            ...
            final Handler handler = new Handler();
            handler.postDelayed(() -> {
                findViewById(R.id.infoscroll4).setVisibility(View.VISIBLE);
        ...
        final Button scrollback2 = findViewById(R.id.backscroll4);                               // wprowadzenie przycisku "scrollback2" odnoszący się to przycisku z layoutu o id "backscroll2.
        scrollback2.setOnClickListener(v -> {                                                    // klikniecie przycisku "scrollback2"
            ...
            final Handler handler = new Handler();
            handler.postDelayed(() -> {
                findViewById(R.id.infoscroll4).setVisibility(View.INVISIBLE);                   // powoduje znikniecie po 0,2s layoutu o id "infoscroll2"
                // w interfejsie użytkownika jest to powrót do głównej zawartości aktywności.
            }, 200);
        ...
        pożyczka2.setOnClickListener(v -> {
            ...
            if (rewardedInterstitialAd != null) {
                rewardedInterstitialAd.show(/* Activity */ page4.this,/*
OnUserEarnedRewardListener */ page4.this);
                mp.pause();
            } else {
                Toast.makeText(page4.this, "Ad Not Loaded", Toast.LENGTH_SHORT).show();
                Log.d(TAG, "Ad Not Loaded");
            }
        });

        opcja2.setOnClickListener(view -> {                                                 // wybór przycisku "opcja1" zmienia stan przycisków poniżej, pozawaljąc użytkownikowi
        ...
        opcja1.setOnClickListener(view -> {                                                 // wybór przycisku "opcja2" zmienia stan przycisków poniżej, pozawaljąc użytkownikowi
        ...
        opcja3.setOnClickListener(view -> {                                                 // wybór przycisku "opcja3" zmienia stan przycisków poniżej, pozawaljąc użytkownikowi
            ...
            if (ilosczlotaa<20){                                                            // jeżeli wartość zmiennej "ilosczlotaa" (zasoby użytkownika) jest mniejsza
        ...
        incorrect2_button2.setOnClickListener(v -> {                                        // kliknięcie przycisku "incorrect2_button2" powoduje:
            ...
            ilosczlotaa = ilosczlotaa - 60;                                                 // zmniejszenie wartości zmiennej "ilosczlotaa" o 50, zmniejszenie zasobów gracza o 50
            SharedPreferences saveLayout = getSharedPreferences(SAVE, MODE_PRIVATE);        // wprowadzenie interfejsu loadLayout pozwalającego przechowywać dane
            SharedPreferences.Editor editor = saveLayout.edit();                            // wczytanie interfejsu umożliwającego zmiany wartości w loadLayout
            ilosczlota2.setText(String.valueOf(ilosczlotaa));                                // aktualizacja wartości wyświetlanej przez tekst "ilosczlota2"
            editor.putInt("ilosczlotaaa", ilosczlotaa);                                     // zmiana wartości przechowywanej w "ilosczlotaaa" na aktualną wartość "ilosczlotaa"
        ...
        incorrect2_button3.setOnClickListener(v -> {                                        // kliknięcie przycisku "incorrect2_button3" powoduje:
            ...
            ilosczlotaa = ilosczlotaa - 20;                                                 // zmniejszenie wartości zmiennej "ilosczlotaa" o 60 zmniejszenie zasobów gracza o 60
            SharedPreferences saveLayout = getSharedPreferences(SAVE, MODE_PRIVATE);        // wprowadzenie interfejsu loadLayout pozwalającego przechowywać dane
            SharedPreferences.Editor editor = saveLayout.edit();                            // wczytanie interfejsu umożliwającego zmiany wartości w loadLayout
            ilosczlota2.setText(String.valueOf(ilosczlotaa));                               // aktualizacja wartości wyświetlanej przez tekst "ilosczlota2"
            editor.putInt("ilosczlotaaa", ilosczlotaa);                                     // zmiana wartości przechowywanej w "ilosczlotaaa" na aktualną wartość "ilosczlotaa"
        ...
        final Button you_lose = findViewById(R.id.powrot4);                                  // wprowadzenie przycisku "you_lose" odnoszącego się do przycisku "powrot" z layoutu użytkownika
        you_lose.setOnClickListener(v -> {                                                  // kliknięcie przycisku "you_lose" powoduje:
            findViewById(R.id.przegrales4).setVisibility(View.INVISIBLE);                    // layout o id "przegrales" staje się niewidoczny, powrót do głównej aktywności
    ...
    private void loadAd() {
        ...
        RewardedInterstitialAd.load(page4.this, "ca-app-pub-3940256099942544/5354046379",
    ...
    public void openpage5(){
        Intent intent4 = new Intent(this, page5.class);                         // wprowadzenie intencji "intent2" otwierającej aktywność "page3.class"
        startActivity(intent4);                                                             // metoda otwierająca aktywność opisaną w intencji "intent2"
    }
